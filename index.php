...
<section class="plan">
    <div class="section_title">
        <h2 class="section_title_main">Plan</h2>
        <p class="section_title_sub">プラン紹介</p>
    </div>
...
<section class="office">
    <div class="section_title">
        <h2 class="section_title_main">Office</h2>
...
<section class="service">
    <div class="section_title">
        <h2 class="section_title_main">Service</h2>
        <p class="section_title_sub">利用可能サービス</p>
    </div>
